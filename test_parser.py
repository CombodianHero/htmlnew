...
def generate_html(data, output_path, user_info=None):
    ...
    user_id = user_info.get('user_id', '123456') if user_info else '123456'
    username = user_info.get('username', 'TestUser') if user_info else 'TestUser'
    first_name = user_info.get('first_name', 'Test User') if user_info else 'Test User'
...
if __name__ == '__main__':
    ...
    test_input = '''(Theory)Lect.-1 EVS Introduction:https://example.com/video1.mp4
(Theory)Lect.-2 EVS Advanced:https://media-cdn.classplusapp.com/video/master.m3u8
(Environment)Lect.-1 EVS Notes:https://example.com/notes.pdf
(Math)Lect.-1 Calculus Basics:https://example.com/calculus.mp4
(Math)Worksheet-1 Problems:https://example.com/worksheet.pdf'''
    ...
    output_file = '/mnt/user-data/outputs/test_output.html'
    generate_html(parsed_data, output_file, test_user)
    ...
    print("  ✓ Fixed video player layout (no scrolling)")
    print("  ✓ PDF opens in fullscreen modal")
    print("  ✓ Auto-scroll to video section when clicking")
    print("  ✓ Watermark with user ID and name")
    print("  ✓ Disabled right-click and inspect")
    print("  ✓ Mobile fullscreen support")
    print("  ✓ Auto-rotate disabled")
