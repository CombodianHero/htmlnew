...
def generate_html(data, output_path):
    """
    Generate HTML file from parsed data with fixed PDF viewer
    """
...
(Math)Lect.-1 Calculus Basics:https://classplusapp.com/video123.m3u8
(Physics)Notes-1 Formulas:https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf
(Math)Worksheet-1 Problems:https://www.africau.edu/images/default/sample.pdf'''
    ...
    print("\n✨ Features:")
    print("  - PDF Viewer now uses Google Docs Viewer (fixes CORS issues)")
    print("  - Fallback to PDF.js if Google Docs fails")
    print("  - Download and Open in New Tab buttons for PDFs")
    print("  - All PDFs should load properly now!")
